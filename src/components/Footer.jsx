      ...
      <footer>
        ...
        <div class="container">
          {/* <div class="row">
            <div class="col">
              <div class="signUp">
                <h5>Want to sign up to receive our newsletter?</h5>
                <h6>It's just like, our news, in a letter, for you.</h6>
        ...
        <div class="container footerBody">
          <div>
            <div class="row">
              <div class="col">
                <ul class="footerText">
                  <li class="footer-list-heading">About Rafiki Yangu</li>
                  <li><a href="https://www.makeawish.org.au/about-us">About us</a></li>
                  <li><a href="https://www.makeawish.org.au/wishes/why-wishes-matter">Why wishes matter</a></li>
                  <li><a href="https://www.makeawish.org.au/about-us/our-board">Our Board</a></li>
                  <li><a href="https://www.makeawish.org.au/about-us/careers">Careers</a></li>
                  <li><a href="https://www.makeawish.org.au/about-us/contact-us">Contact us</a></li>
                </ul>
              </div>
              <div class="col">
                <ul class="footerText">
                  <li class="footer-list-heading">Partners &amp; supporters</li>
                  <li><a href="https://www.makeawish.org.au/support/partner">Partner with us</a></li>
                  <li><a href="https://www.makeawish.org.au/support/events">Events</a></li>
                </ul>
              </div>
              <div class="col">
                <ul class="footerText">
                  <li class="footer-list-heading">Media &amp; news</li>
                  <li><a href="https://www.makeawish.org.au/wishes/wish-stories">Wish stories</a></li>
                  <li><a href="https://www.makeawish.org.au/news">News</a></li>
                </ul>
              </div>
              <div class="col">
                <div class="row">
                  <ul class="footerText">
                    <li class="footer-list-heading">Community</li>
                    <li><a href="https://www.makeawish.org.au/wishes/apply">Apply for a wish</a></li>
                    <li><a href="https://mawa.force.com/Volunteers/s/login">Volunteer Community login</a></li>
                  </ul>
                </div>
                <div class="row">
          ...
          {/* <div class="CharityBrands">Logos go here</div> */}
        <hr/>
        <div class="container">
          <ul className="row">
            <li class="col-6">
              ⓒ {year} Rafiki Yangu | ABN ## ### ### ### | Donations over $2 are tax deductible
            </li>
            <li class="col">
              <a href="https://www.makeawish.org.au/about-us/terms-and-conditions/privacy-policy">Privacy Policy</a>
            </li>
            <li class="col">
              <a href="https://www.makeawish.org.au/about-us/terms-and-conditions/terms-of-use">Terms of Use</a>
            </li>
            <li class="col-3">
              <a href="https://www.makeawish.org.au/about-us/terms-and-conditions/child-safeguarding-policy">Commitment to Child Safety</a>
            </li>
          </ul>
        </div>
        </div>
